---
title: "PostgreSQL 9.0 modify pg_attribute.atttypmod extend variable char length avoid rewrite table"
author: "digoal"
date:  2013-06-17
tags: [PostgreSQL , atttypmod , pg_attribute , rewrite table]
---
## 背景           
