---
title: "PostgreSQL 大对象或bytea存取pdf,jpg等文件 - PostgreSQL export regular file like pdf, word, text, doc stored in bytea type"
author: "digoal"
date:  2013-06-26
tags: [PostgreSQL , bytea , large object , 大对象 , 存取 , export , import]
---
## 背景      
