---
title: "递归优化CASE - performance tuning case :use cursortriggerrecursive replace (group by and order by) REDUCE needed blockes scan"
author: "digoal"
date:  2012-09-14
tags: [PostgreSQL , 递归查询 , group by , order by , cursor , 性能优化]
---
## 背景          
一个比较经典的SQL如下 :   
