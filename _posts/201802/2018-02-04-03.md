---
title: "PostgreSQL 11 preview - Parallel Append(包括 union all分区查询) (多表并行计算) sharding架构并行计算核心功能之一"
author: "digoal"
date:  2018-02-04
tags: [PostgreSQL , 多表并行 , parallel append , sharding , 外部表 , 继承 , 分区表 , union , pg_pathman , inherit]
---
## 背景    
