---
title: "PostgreSQL dblink异步调用实现 并行hash分片JOIN - 含数据交、并、差 提速案例 - 含dblink VS pg 11 parallel hash join VS pg 11 智能分区JOIN"
author: "digoal"
date:  2018-02-01
tags: [PostgreSQL , 并行哈希join , parall hash join , dblink , 异步调用 , hash]
---
## 背景       
