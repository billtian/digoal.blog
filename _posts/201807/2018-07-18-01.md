---
title: "PostgreSQL merge insert(insert into on conflict) ERRCODE_CARDINALITY_VIOLATION （Ensure that no rows proposed for insertion within the same command have duplicate constrained values）"
author: "digoal"
date:  2018-07-18
tags: [PostgreSQL , insert into on conflict , merge insert]
---
## 背景        
