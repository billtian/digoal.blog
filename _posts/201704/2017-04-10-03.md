---
title: "PostgreSQL物理备库的哪些操作或配置，可能影响主库的性能、垃圾回收、IO波动"
author: "digoal"
date:  2017-04-10
tags: [PostgreSQL , 物理复制 , 垃圾回收 , vacuum_defer_cleanup_age , hot_standby_feedback , max_standby_archive_delay , max_standby_streaming_delay]
---
## 背景   
