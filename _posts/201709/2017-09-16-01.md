---
title: "如何用一个回形针换一栋别墅 - openBarter (古人的物物交换市场) 类撮合交易系统"
author: "digoal"
date:  2017-09-16
tags: [PostgreSQL , 物物交换 , 无货币时代 , openBarter , 交易系统 , 撮合交易 , 证券 , limit order , market order , central limit order book (CLOB)]
---
## 背景        
