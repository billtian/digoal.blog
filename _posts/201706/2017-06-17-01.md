---
title: "自动选择正确索引访问接口(btree,hash,gin,gist,sp-gist,brin,bitmap...)的方法"
author: "digoal"
date:  2017-06-17
tags: [PostgreSQL , 索引接口 , 自动创建索引 , 自动选择索引接口 , (btree,hash,bitmap,gin,gist,sp-gist,brin,rum,bloom,zoomdb)]
---
## 背景      
