---
title: "Greenplum支持人为多阶段聚合的方法 - 直连segment(PGOPTIONS='-c gp_session_role=utility') Or gp_dist_random('gp_id') Or 多阶段聚合 prefunc"
author: "digoal"
date:  2018-06-24
tags: [PostgreSQL , 多阶段聚合 , 直连segment , gp_dist_random('gp_id')]
---
## 背景    
