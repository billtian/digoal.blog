---
title: "执行计划选择算法 与 绑定变量 - PostgreSQL prepared statement: SPI_prepare, prepare execute COMMAND, PL/pgsql STYLE: custom & generic plan cache"
author: "digoal"
date:  2012-12-24
tags: [PostgreSQL , 绑定变量 , 绑定执行计划 , custom scan , generic plan cache]
---
## 背景                                  
