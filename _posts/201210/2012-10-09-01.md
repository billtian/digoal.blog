---
title: "递归优化CASE - group by & distinct tuning case : use WITH RECURSIVE and min() function"
author: "digoal"
date:  2012-10-09
tags: [PostgreSQL , 递归查询 , group by , order by , cursor , 性能优化 , with recursive]
---
## 背景            
今天要说的这个优化是从前面一篇讲解[《performance tuning case :use cursor or trigger replace group by and order by》](../201209/20120914_01.md)的延展.  
