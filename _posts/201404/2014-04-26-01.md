---
title: "索引顺序扫描引发的堆扫描IO放大背后的统计学原理与解决办法 - PostgreSQL index scan enlarge heap page scans when index and column correlation small."
author: "digoal"
date:  2014-04-26
tags: [PostgreSQL , 优化器 , 索引扫描 , 堆扫描 , IO放大]
---
## 背景                   
