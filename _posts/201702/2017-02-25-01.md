---
title: "PostgreSQL 向量化执行插件(瓦片式实现-vops) 10x提速OLAP"
author: "digoal"
date:  2017-02-20
tags: [PostgreSQL , OLAP , 向量化 , vector , postgrespro , tiles , 瓦片 , 瓦片索引 , map , reduce , 分组聚合 , 非分组聚合 , 分区键 , sort key , order by , brin , cpu Cache , projection , 行列变换]
---
