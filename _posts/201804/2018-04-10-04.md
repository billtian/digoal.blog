---
title: "PostgreSQL 单库对象过多，触发Linux系统限制(inode满或inode index满) (ext4_dx_add_entry: Directory index full!) (could not create file xx/xx/xxxxxx: No space left on device)"
author: "digoal"
date:  2018-04-10
tags: [PostgreSQL , Linux , 对象 , inode 限制 , 目录数限制]
---
## 背景    
