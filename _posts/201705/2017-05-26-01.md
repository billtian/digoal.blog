---
title: "数据库的未来 - HTAP，软件、硬件、云生态的融合"
author: "digoal"
date:  2017-05-26
tags: [PostgreSQL , GPU , FPGA , CPU , TPU , PL/language , 科研 , 嵌入式计算 , UDF , CUDA , 数据库嵌入式编程 , 流式计算 , 科学计算 , 软硬一体 , PostGIS , 点云 , 开发者生态 , python library , CRAN , R]
---
## 背景       
