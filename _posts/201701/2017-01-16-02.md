---
title: "PostgreSQL结合余弦、线性相关算法 在文本、图片、数组相似 等领域的应用 - 1 文本(关键词)分析理论基础 - TF(Term Frequency 词频)/IDF(Inverse Document Frequency 逆向文本频率)"
author: "digoal"
date:  2017-01-16
tags: [PostgreSQL , 文本分析 , tf , idf , tf-idf , tag]
---
