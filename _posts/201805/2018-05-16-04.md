---
title: "PostgreSQL 时间点恢复(PITR)时查找wal record的顺序 - loop(pg_wal, restore_command, stream)"
author: "digoal"
date:  2018-05-16
tags: [PostgreSQL , 物理恢复 , startup , wal , restore_command , recovery.conf , stream replication]
---
## 背景   
