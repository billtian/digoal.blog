---
title: "PostgreSQL 9.5 new feature - pg_dump use --snapshot taken by another session (exp. slot, pg_export_snapshot())"
author: "digoal"
date:  2015-06-16
tags: [PostgreSQL , pg_dump , snapshot , 并行备份 , 共享事务快照 , 导出事务快照 , 并行一致性备份]
---
## 背景         
