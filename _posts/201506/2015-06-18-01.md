---
title: "生成泊松、高斯、指数、随机分布数据 - PostgreSQL 9.5 new feature - pgbench improve, gaussian (standard normal) & exponential distribution"
author: "digoal"
date:  2015-06-18
tags: [PostgreSQL , pgbench , 泊松 , 正态 , 高斯 , 指数 , 随机]
---
## 背景              
