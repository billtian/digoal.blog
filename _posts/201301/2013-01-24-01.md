---
title: "PostgreSQL performance speedup by avoid lock references tuple when add or update(new) Foreign Key's value"
author: "digoal"
date:  2013-01-24
tags: [PostgreSQL , 主外键表更新加速 , for key share , for key update]
---
## 背景                 
